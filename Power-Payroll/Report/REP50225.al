report 50225 "Tax Witholding Cert - New"
{
    // version ASHNEILCHANDRA_PAYROLL

    DefaultLayout = RDLC;
    RDLCLayout = './Tax Witholding Cert - New.rdlc';
    ...
    var
        ...
        TEXT002 : TextConst ENU='TAX WITHHOLDING CERTIFICATE',ENA='TAX WITHHOLDING CERTIFICATE';
        ...
        TEXT029 : TextConst ENU='IRS452A [Revised: 21-Sept-2017 ]      ',ENA='IRS452A [Revised: 23-Dec-2013]';
