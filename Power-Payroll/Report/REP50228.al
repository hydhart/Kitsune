report 50228 "PAYE Certificate - Test"
{
    // version ASHNEILCHANDRA_PAYROLL

    DefaultLayout = RDLC;
    RDLCLayout = './PAYE Certificate - Test.rdlc';
    ...
    dataset
    {
        dataitem(Employee;"Employee Pay Details")
        {
            ...
            column(ECALDeducted_Employee;Employee."ECAL Deducted")
            {
            }
    ...
    begin
        ...
        IF Employee.FINDFIRST() THEN REPEAT
          ...
          IF PAYRUN.FIND('-') THEN REPEAT
            ...
            END;
            IF PAYRUN."Pay Code" = HRSETUP.ECAL THEN BEGIN
              MECAL := MECAL + PAYRUN.Amount;
            END;
          UNTIL PAYRUN.NEXT=0;
    ...
    var
        ...
        TEXT002 : TextConst ENU='PAYE-AS-YOU-EARN (PAYE) EMPLOYEE CERTIFICATE',ENA='TAX WITHHOLDING CERTIFICATE';
        ...
        TEXT029 : TextConst ENU='<IRS452 [Revised: 03-Aug-2017]>',ENA='IRS452A [Revised: 23-Dec-2013]';
