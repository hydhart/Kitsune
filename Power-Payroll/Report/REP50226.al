report 50226 "Electronic Banking WBCp"
{
    // version ASHNEILCHANDRA_PAYROLL

    DefaultLayout = RDLC;
    RDLCLayout = './Electronic Banking WBCp.rdlc';
        ...
        dataitem("Bank Pay Distribution";"Bank Pay Distribution")
        {
            ...
            begin
                ...
                IF NOT ElectronicBanking.FINDFIRST() THEN BEGIN
                  ...
                  ElectronicBanking."Print 180" := DRecordType +','+ DBank +','+ DState +','+ DBranch +','+ DAccount +','+ DTransactionCode +','+ DAmount +','+ DTPName +','+ DTPReference1
            ...
            begin
                ...
                IF NOT ElectronicBanking.FINDFIRST() THEN BEGIN
                  ...
                  ElectronicBanking."Print 180" := TRecordType +','+ THashTotal +','+ TBatchNumber +','+ Filler3 +','+ TBatchValue +','+ Filler131;
                  ElectronicBanking.INSERT;
                END;
                //-------------------------Footer Record--------------
            end;
    ...
    begin
        ...
        IF NOT ElectronicBanking.FINDFIRST() THEN BEGIN
          ...
          ElectronicBanking."Print 180" := HRecordType +','+ HBank +','+ HState +','+ HBranch +','+ HAccount +','+ HBatch +','+ Filler1
    ...
    var
        ...
        XMLPT : XMLport "Electronic Banking PEX";
        HBank : Label '03';
