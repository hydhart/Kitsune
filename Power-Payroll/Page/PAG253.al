        ...
        area(content)
        {
            field(CurrentJnlBatchName;CurrentJnlBatchName)
            {
                ...
                CaptionML = ENU='Batch Name',
                            ENA='Batch Name';
                Lookup = true;
                ToolTipML = ENU='Specifies the batch name on the sales journal.',
                            ENA='Specifies the batch name on the sales journal.';
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTipML = ENU='Specifies the customer''s product type to link transactions made for this customer with the appropriate general ledger account according to the general posting setup.',
                                ENA='Specifies the customer''s product type to link transactions made for this customer with the appropriate general ledger account according to the general posting setup.';
                }
                ...
                {
                    ToolTipML = ENU='Specifies the line''s profit amount if you are using this journal line for an invoice.',
                                ENA='Specifies the line''s profit amount if you are using this journal line for an invoice.';
                    Visible = false;
                }
                ...
                field("On Hold";"On Hold")
                {
                    ToolTipML = ENU='Specifies if the journal line has been invoiced and you execute the payment suggestions batch job, or a finance charge memo or reminder.',
                                ENA='Specifies if the journal line has been invoiced and you execute the payment suggestions batch job, or a finance charge memo or reminder.';
                    Visible = false;
                }
                    ...
                    group(Control1903866901)
                    {
                        ...
                        field(Balance;Balance + "Balance (LCY)" - xRec."Balance (LCY)")
                        {
                            ...
                            CaptionML = ENU='Balance',
                                        ENA='Balance';
                            Editable = false;
                            ToolTipML = ENU='Specifies the balance that has accumulated in the sales journal on the line where the cursor is.',
                                        ENA='Specifies the balance that has accumulated in the sales journal on the line where the cursor is.';
                    ...
                    group("Total Balance")
                    {
                        ...
                        field(TotalBalance;TotalBalance + "Balance (LCY)" - xRec."Balance (LCY)")
                        {
                            ...
                            CaptionML = ENU='Total Balance',
                                        ENA='Total Balance';
                            Editable = false;
                            ToolTipML = ENU='Specifies the total balance in the sales journal.',
                                        ENA='Specifies the total balance in the sales journal.';
